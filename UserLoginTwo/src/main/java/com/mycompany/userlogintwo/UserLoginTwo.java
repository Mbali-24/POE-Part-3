...
package com.mycompany.userlogintwo;
...
public class UserLoginTwo {
    public static void main(String[] args) {
        ...
        //Creating objects for the Scanners
        ...
        while (!methods.checkUsername() || !methods.checkPasswordComplexity()) {
            ...
            System.out.print("Please re-create a username: ");
            methods.userName = input.next();
            System.out.print("Please re-create a password: ");
            methods.password = input.next();
            System.out.println(methods.registerUser());
        }
        ...
        //Process data using an IF statement
